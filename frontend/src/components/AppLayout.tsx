...
const MENU: MenuItem[] = [
  ...
  { key: '/liquidations', icon: <DeleteOutlined />, label: <Link to="/liquidations">Thanh lý</Link>, roles: [ROLES.SYSTEM_ADMIN, ROLES.ASSET_MANAGER, ROLES.APPROVING_AUTH, ROLES.FINANCE_AUDIT] },
